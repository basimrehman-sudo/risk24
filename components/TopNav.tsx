  ...
  return (
    <header className="h-[72px] bg-white border-b border-slate-200 flex items-center justify-end px-6 shrink-0 z-10 sticky top-0 w-full">
      <div className="flex items-center gap-6">
        ...
        <button className="flex items-center gap-2 text-slate-700 hover:text-slate-900 font-medium px-4 py-2 border border-slate-200 rounded-full hover:bg-slate-50 transition-colors text-sm">
          <span>Create Risk Alert</span>
          <Plus size={16} />
        </button>

        <div className="flex items-center gap-4 text-slate-600">
          <button className="relative p-1 hover:text-slate-900 transition-colors">
        ...
        <div className="flex items-center gap-2 cursor-pointer rounded-full border-2 border-transparent hover:border-slate-200 transition-colors">
          <img 
